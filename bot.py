...
extension = ['cogs.help', 'cogs.help_command', 'cogs.General_Commands', 'cogs.Fun_Commands', 'cogs.mc', 'cogs.Suggestions', 'cogs.Moderation', 'cogs.Administrator_Commands', 'cogs.global']
