...
class Application(commands.Cog):
    ...
    async def applymod(self, ctx, member: discord.Member = None):
        ...
        try:
            doodoo = discord.Embed(title="Application will start soon...", description="Remember to be 100% Honest and provide good answers!\nThe Questions will be sent shortly...", color=discord.Color.dark_orange())
            ...
            channel = self.bot.get_channel(723019029488599090)
